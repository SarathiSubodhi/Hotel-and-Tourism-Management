...
const AdminViewPackages = () => {
    ...
    const generatePDFReport = () => {
        ...
        doc.autoTable({
            head: [['Name', 'Description', 'Price', 'Duration', 'Amenities','Season']],
            body: filteredPackages.map((item) => [item.name, item.description, item.price, item.duration, item.amenities, item.season]),
        });
    ...
    return (
        <div className="container mt-5">
            <h2 className="text-start mb-4">TOUR PACKAGES</h2>
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <ul className="list-group mb-3">
                                    ...
                                    <li className="list-group-item">Season: {item.season}</li>
                                </ul>
